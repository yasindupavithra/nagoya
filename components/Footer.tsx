        ...
        <div className="footer-grid">
          ...
          <div>
            ...
            <div className="footer-contact-item">
              <a href="tel:+94714495632" style={{ color: 'inherit', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            <div className="footer-contact-item">
              <a href="https://wa.me/94714495632" target="_blank" rel="noreferrer" style={{ color: 'inherit', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            <div className="footer-contact-item">
              <a href="https://www.facebook.com/share/1Eo4ruhviG/?mibextid=qi2Omg" target="_blank" rel="noreferrer" style={{ color: 'inherit', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 6 }}>
